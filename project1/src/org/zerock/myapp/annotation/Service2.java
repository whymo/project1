...
//public class @MyAnnotation Service2 {	 // class 와 클래스명은 한몸이여서 쪼개서 들어갈 수 없다
...
//	@MyAnnotation
//	public Service2(@MyAnnotation String instanceField, @MyAnnotation final int age) {	// 자바 컴파일러가 만드는 기본 생성자
//		;;								// 위에 인스턴스 필드 초기화 하라
//	}// default constructor
	
	
//	@MyAnnotation public Service2(@MyAnnotation String instanceField, @MyAnnotation final int age) {
	 public @MyAnnotation Service2(
...
//	@MyAnnotation private static final double PI = 3.14159;
//	private @MyAnnotation static final double PI = 3.14159;
//	private static @MyAnnotation final double PI = 3.14159;
//	private static  final @MyAnnotation double PI = 3.14159;
//	private static  final  double @MyAnnotation PI = 3.14159; 		// XX : 타입 뒤에는 변수명이 와야한다
//	=> $ , _ 시작할 수 있는데 @ 이 기호는 자바 식별자에서 사용할 수 없는 기호라서 한몸이 될 수 없다! 
	
	
	@MyAnnotation			// 어노테이션에 다 기본값이 있기 때문에 오류가 안난다!
	public void instanceMethod(
			@MyAnnotation int age		// OK
//			int @MyAnnotation age		// XX
	) {	// 매개변수에도 붙일 수 있다
//	@MyAnnotation public void instanceMethod(@MyAnnotation int age) {	//OK
//	public @MyAnnotation void instanceMethod(@MyAnnotation int age) {	//OK		
//	public void @MyAnnotation instanceMethod(@MyAnnotation int age) {	//XX => 메소드 이름이라면 식별자 규칙 지켜야 함!!
		
		@MyAnnotation
		int temp;			// 지역변수
//		final int temp = 0;			// final 붙일 수 있다 , 붕어빵1 만을 위한 상수이다
//		@MyAnnotation int temp;			// ok
//		int @MyAnnotation temp;			// xx
